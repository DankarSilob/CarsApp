...
@synthesize carMakeDetail, carModelDetail, carPhotoDetail, infoCarArray;

- (void)viewDidLoad
{
    [super viewDidLoad];
    
    carMakeDetail.text = infoCarArray[0];
    carModelDetail.text = infoCarArray[1];
    carPhotoDetail.image = [UIImage imageNamed:infoCarArray[2]];
